...
class MutationMCLWithIsland:
    ...
    def __init__(self, population, _tau1, _tau2, _eps0, x_lim=(-30, 30), device='cpu'):
        ...
        self.dimension = int(((self.dimension - 1) / 2))
        self.population_x = population[:, 1:self.dimension+1]
        self.population_sigma = population[:, self.dimension+1:]
        self.x_lim = x_lim
