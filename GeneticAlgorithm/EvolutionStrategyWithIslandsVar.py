...
from .DiscreteXUniformSWithIslandVar import DiscreteXUniformSWithIslandVar
...
class EvolutionStrategyWithIslandsVar:
    ...
    def __init__(self,
        ...
        self.recombination = DiscreteXUniformSWithIslandVar(parents_tensor=self.population,
        ...
        self.iter_register = GARegister(filename=filename,
                                        algo_name='ES{}IslandVar'.format(n_island),
