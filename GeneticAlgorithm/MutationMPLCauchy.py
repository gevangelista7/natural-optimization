...
class MutationMPLCauchy:
    ...
    def __init__(self, population, offspring, _tau1, _tau2, _eps0, x_lim=(-30, 30), rate=None, device='cpu'):
        ...
        self.device = device
        self.factors = t.empty((self._lambda-self._mu, self.dimension), device=self.device)
    ...
    def execute(self):
        ...
        self.offspring_x[self._mu:] += self.offspring_sigma[self._mu:] * self.factors.cauchy_()
