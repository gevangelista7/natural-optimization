...
from GeneticAlgorithm import EvolutionaryProgramming, FitnessFunctionWithCounter
...
if __name__ == '__main__':
    ...
    results_registry = GARegister(algo_name="EP",
                                  filename="EP_Ackley_{}".format(dim),
    ...
    for params in product(mu_list, lambda_mu_list):
        ...
        while i < n_rounds:
            ...
            algo = EvolutionaryProgramming(individual_dimension=dim,
